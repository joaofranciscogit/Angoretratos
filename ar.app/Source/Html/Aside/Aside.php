<aside class="col-lg-2 col-md-3 border-end pb-5 mt-n5">
    <div class="position-sticky top-0">
        <div class="text-center pt-5">
            <div class="d-table position-relative mx-auto mt-2 mt-lg-4 pt-5 mb-3">
                <img src="<?php echo ASSET; ?>/img/avatar/18.jpg" class="d-block rounded-circle" width="120" alt="John Doe">
            ...
            <div id="account-menu" class="list-group list-group-flush collapse d-md-block">
                <a href="account-details.html" class="list-group-item list-group-item-action d-flex align-items-center active shadow-none">
