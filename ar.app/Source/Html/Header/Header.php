<header class="container header navbar navbar-expand-lg navbar-light bg-light border-bottom border-light shadow-sm fixed-top">
        <div class="container px-3">
          <a href="index.html" class="navbar-brand pe-3">
            <img src="<?php echo  ASSET; ?>img/logo.svg" width="47" alt="Silicon">
            Silicon
          </a>
              ...
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu p-0">
                    <div class="d-lg-flex">
                      <div class="mega-dropdown-column bg-position-center bg-repeat-0 bg-size-cover rounded-3 rounded-end-0" style="background-image: url(<?php echo  ASSET; ?>img/landings.jpg); margin: -1px;"></div>
